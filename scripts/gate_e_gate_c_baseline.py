...
def build_baseline(bus: dict, rail: dict, *, gate_c_commit: str, bus_artifact: str, rail_artifact: str) -> list[dict[str, object]]:
    ...
    for route_id in BUS_ROUTES_REQUIRED:
        ...
        rows.append({
            ...
            "source_epistemic_detail": str(route.get("epistemic_status", "RECONSTRUCTED")).upper(),
    ...
    rows.append({
        ...
        "source_epistemic_detail": "SUM_OF_RECONSTRUCTED_OFFICIAL_TIMETABLE_COLUMNS",
        "source_class": str(bus.get("source_class", "")),
        "valid_from": "",
        "valid_to": "",
        "gate_c_status": "PASS",
    ...
    rows.append({
        ...
        "epistemic_status": "DERIVED",
        "source_epistemic_detail": "COUNT_FROM_LIVE_OFFICIAL_GTFS_FACT_ROWS",
