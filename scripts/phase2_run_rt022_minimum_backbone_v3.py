#!/usr/bin/env python3
"""Execute the exact minimum-backbone scope of RT-022 against frozen RT-021."""
...
from src.phase2_territorial_structural_search_minimal_v3 import (
    run_rt022_exact_minimum_backbones,
)
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("outputs/phase2/rt022_minimum_backbones_v3"))
...
def main() -> int:
    args = _parse_args()
    result = run_rt022_exact_minimum_backbones(
        pd.read_csv(args.attachments),
        pd.read_csv(args.pair_manifest),
        pd.read_csv(args.pair_results),
        pd.read_csv(args.corridors),
    ...
    outputs = {
        ...
        "elementary_corridors_for_reciprocity.csv": result["elementary_corridors_for_reciprocity"],
        ...
        "minimum_topology_neutral_backbone_universe.csv": result["structures"],
    }
    ...
    audit = {
        ...
        "counts": {
            ...
            "exact_minimum_backbones": int(len(result["structures"])),
        },
        "digests": result["digests"],
        "search_metadata": result["frontier_metadata"],
        "guards": {
            ...
            "larger_structure_claimed_complete": False,
        },
    }
    (out / "rt022_minimum_backbone_audit.json").write_text(
