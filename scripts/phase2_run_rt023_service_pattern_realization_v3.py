...
from phase2_service_pattern_realization_bridge_certified_v3 import compile_certified_rt023_bridge, write_bridge_result
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--stop-attachments", type=Path, required=True)
...
def main() -> int:
    ...
    result = compile_certified_rt023_bridge(
