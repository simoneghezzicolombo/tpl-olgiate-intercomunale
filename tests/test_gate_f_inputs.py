...
def _write_fragments(tmp_path, *, infeasible_alt=False, omit_ineligible_metrics=False):
    catalog = pd.DataFrame([
        {
            "scenario_id": "BASE",
            "scenario_name": "Current network",
            "topology_family": "CURRENT",
            "is_baseline": "True",
            "scenario_epistemic_status": "RECONSTRUCTED",
            "scenario_source": "TEST_CATALOG",
        },
        {
            "scenario_id": "ALT",
            "scenario_name": "Alternative topology",
            "topology_family": "OTHER",
            "is_baseline": "False",
