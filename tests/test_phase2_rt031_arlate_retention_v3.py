...
def test_diagnostic_rovagnate_lane_does_not_omit_base_probes():
    current = ("FROZEN::L00407", "FROZEN::300063", "FROZEN::300805",
               "FROZEN::300086", "FROZEN::300398", "FROZEN::300487",
               "FROZEN::300634", "FROZEN::300879", "FROZEN::300956")
    targets = probe_targets(current, 3, "FROZEN::300879")
    assert len(targets) == 22
    assert sum(not stops for _, stops in targets) == 2
    assert all("FROZEN::300879" in stops for _, stops in targets if stops)
